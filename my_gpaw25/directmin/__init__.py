...
from my_gpaw25.directmin.sd_etdm import SteepestDescent, FRcg, LBFGS, \
    LBFGS_P, LSR1P, ModeFollowing
from my_gpaw25.directmin.ls_etdm import MaxStep, StrongWolfeConditions
...
def partial_diagonalizer(method, domom):
    from my_gpaw25.directmin.derivatives import Davidson
    if isinstance(method, str):
        method = xc_string_to_dict(method)
