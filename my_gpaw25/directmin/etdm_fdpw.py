...
from my_gpaw25.directmin import search_direction, line_search_algorithm
from my_gpaw25.directmin.fdpw.etdm_inner_loop import ETDMInnerLoop
from my_gpaw25.directmin.fdpw.pz_localization import PZLocalization
from my_gpaw25.directmin.functional.fdpw import get_functional
from my_gpaw25.directmin.locfunc.localize_orbitals import localize_orbitals
from my_gpaw25.directmin.tools import get_n_occ, sort_orbitals_according_to_occ
...
class FDPWETDM:
    ...
    def initialize_eigensolver(self, wfs, ham):
        ...
        from my_gpaw25.eigensolvers.eigensolver import Eigensolver
