...
from my_gpaw25.nlopt.basic import NLOData
from my_gpaw25.utilities.progressbar import ProgressBar

if TYPE_CHECKING:
    from my_gpaw25.nlopt.adapters import CollinearGSInfo, NoncollinearGSInfo
    from my_gpaw25.typing import ArrayND
...
def make_nlodata(calc: ASECalculator | str | Path,
    ...
    if calc.dft.density.collinear:
        from my_gpaw25.nlopt.adapters import CollinearGSInfo
        gs = CollinearGSInfo(calc)
    else:
        from my_gpaw25.nlopt.adapters import NoncollinearGSInfo
