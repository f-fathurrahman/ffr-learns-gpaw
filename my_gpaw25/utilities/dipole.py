...
from my_gpaw25.new.ase_interface import ASECalculator, GPAW
...
def dipole_matrix_elements(*args, **kwargs):
    ...
    Use
    ``my_gpaw25.new.pwfd.wave_functions.PWFDWaveFunctions.dipole_matrix_elements``
    instead.
    """
...
def main(argv: list[str] = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog='python3 -m my_gpaw25.utilities.dipole',
