...
from my_gpaw25.lcaotddft.densitymatrix import DensityMatrix
from my_gpaw25.lcaotddft.magneticmomentwriter import MagneticMomentWriter
from my_gpaw25.lcaotddft.magneticmomentwriter import parse_header
from my_gpaw25.tddft.spectrum import rotatory_strength_spectrum
from my_gpaw25.tddft.units import as_to_au, eV_to_au, au_to_eV, rot_au_to_cgs

from my_gpaw25.test import only_on_master
...
def test_spectrum(in_tmp_dir, rng):
    from my_gpaw25.utilities.folder import Folder
