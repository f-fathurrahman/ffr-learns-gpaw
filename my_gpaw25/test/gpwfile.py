...
from my_gpaw25 import Davidson, FermiDirac, GPAW, Mixer, PW
from my_gpaw25.mpi import world, serial_comm
from my_gpaw25.new.ase_interface import GPAW as GPAWNew
from my_gpaw25.poisson import FDPoissonSolver, PoissonSolver
...
class GPWFiles(CachedFilesHandler):
    ...
    def na2_isolated(self):
        ...
        from my_gpaw25.fdtd.polarizable_material import (
            PermittivityPlus,
            PolarizableMaterial,
            PolarizableSphere,
        )
