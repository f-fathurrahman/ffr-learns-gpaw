...
from my_gpaw25.response.localft import (LocalFTCalculator, MicroSetup,
                                   add_total_density, add_LSDA_Wxc)
from my_gpaw25.response.pair_functions import get_pw_coordinates
from my_gpaw25.test.response.test_site_kernels import get_pw_descriptor
...
def test_localft_paw_engine(a):
    ...
    from my_gpaw25.sphere.lebedev import Y_nL
