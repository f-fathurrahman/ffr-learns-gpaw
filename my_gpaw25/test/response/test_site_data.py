...
from my_gpaw25.sphere.integrate import integrate_lebedev

from my_gpaw25.response import ResponseGroundStateAdapter
from my_gpaw25.response.site_data import (AtomicSites, AtomicSiteData,
                                     calculate_site_magnetization,
                                     calculate_site_zeeman_energy,
                                     get_site_radii_range,
                                     maximize_site_magnetization)
from my_gpaw25.response.localft import add_spin_polarization
...
class DummyAdapter(ResponseGroundStateAdapter):
    def __init__(self, calc):
        from my_gpaw25.response.groundstate import PAWDatasetCollection
