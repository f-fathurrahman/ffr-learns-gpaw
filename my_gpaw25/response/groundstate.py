...
from my_gpaw25.ibz2bz import IBZ2BZMaps
from my_gpaw25.calculator import GPAW as OldGPAW
from my_gpaw25.new.ase_interface import ASECalculator as NewGPAW
from my_gpaw25.response.paw import LeanPAWDataset

if TYPE_CHECKING:
    from my_gpaw25.setup import Setups, LeanSetup
...
class ResponseGroundStateAdapter:
    def __init__(self, calc: GPAWCalculator):
        wfs = calc.wfs  # wavefunction object from my_gpaw25.wavefunctions

        self.atoms = calc.atoms
        self.kd = wfs.kd  # KPointDescriptor object from my_gpaw25.kpt_descriptor.
        self.world = calc.world  # _Communicator object from my_gpaw25.mpi

        # GridDescriptor from my_gpaw25.grid_descriptor.
        # Describes a grid in real space
        self.gd = wfs.gd

        # Also a GridDescriptor, with a finer grid...
        self.finegd = calc.density.finegd
        self.bd = wfs.bd  # BandDescriptor from my_gpaw25.band_descriptor
        ...
        self.kpt_u = wfs.kpt_u  # kpoints: list of Kpoint from my_gpaw25.kpoint
        self.kpt_qs = wfs.kpt_qs  # kpoints: list of Kpoint from my_gpaw25.kpoint
    ...
    def from_gpw_file(cls, gpw: GPWFilename) -> ResponseGroundStateAdapter:
        ...
        from my_gpaw25 import GPAW, disable_dry_run
    ...
    def pair_density_paw_corrections(self, qpd):
        from my_gpaw25.response.paw import get_pair_density_paw_corrections
    ...
    def matrix_element_paw_corrections(self, qpd, rshe_a):
        from my_gpaw25.response.paw import get_matrix_element_paw_corrections
    ...
    def get_ibz_vertices(self):
        ...
        from my_gpaw25.bztools import get_bz
        # NB: We are ignoring the pbc_c keyword to get_bz() in order to mimic
        # find_high_symmetry_monkhorst_pack() in my_gpaw25.bztools. XXX
    ...
    def micro_setups(self):
        from my_gpaw25.response.localft import extract_micro_setup
        micro_setups = []
    ...
    @cached_property
    def kpoints(self):
        from my_gpaw25.response.kpoints import ResponseKPointGrid
