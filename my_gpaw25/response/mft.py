...
from my_gpaw25.response import ResponseGroundStateAdaptable, ResponseContextInput
from my_gpaw25.response.frequencies import ComplexFrequencyDescriptor
from my_gpaw25.response.chiks import (ChiKSCalculator, get_smat_components, smat,
                                 regularize_intraband_transitions)
from my_gpaw25.response.localft import LocalFTCalculator, add_LSDA_Wxc
from my_gpaw25.response.site_kernels import SiteKernels
from my_gpaw25.response.site_data import AtomicSites
from my_gpaw25.response.pair_integrator import PairFunction, PairFunctionIntegrator
from my_gpaw25.response.pair_transitions import PairTransitions
from my_gpaw25.response.matrix_elements import (SitePairDensityCalculator,
...
class SingleParticleSiteSumRuleCalculator(PairFunctionIntegrator):
    ...
    def add_integrand(self, kptpair, weight, site_function):
        ...
        The integrand is given by (see my_gpaw25.response.pair_integrator)
                     __
                     \
