...
from my_gpaw25.bztools import convex_hull_volume
from my_gpaw25.response import timer
from my_gpaw25.response.pair import KPointPairFactory
from my_gpaw25.response.frequencies import NonLinearFrequencyDescriptor
from my_gpaw25.response.pair_functions import SingleQPWDescriptor
from my_gpaw25.response.pw_parallelization import block_partition
from my_gpaw25.response.integrators import (
    Integrand, PointIntegrator, TetrahedronIntegrator, Domain)
from my_gpaw25.response.symmetry import QSymmetryInput, QSymmetryAnalyzer
from my_gpaw25.response.kpoints import KPointDomain, KPointDomainGenerator

if TYPE_CHECKING:
    from my_gpaw25.response.pair import ActualPairDensityCalculator
    from my_gpaw25.response.context import ResponseContext
...
class Chi0ComponentCalculator:
    ...
    def check_high_symmetry_ibz_kpts(self):
        ...
        # my_gpaw25.bztools.find_high_symmetry_monkhorst_pack()
        ...
        for ibz_vertex_c in ibz_vertices_kc:
            ...
            if not np.any(nodiff_k):
                raise ValueError(
                    ...
                    'my_gpaw25.bztools to generate your k-point grid.')
