...
from my_gpaw25.response.symmetrize import HeadSymmetryOperators
from my_gpaw25.response.integrators import Integrand, HilbertTetrahedron, Intraband
from my_gpaw25.response.chi0_base import Chi0ComponentCalculator
from my_gpaw25.response.chi0_data import Chi0DrudeData
from my_gpaw25.response.frequencies import FrequencyGridDescriptor

if TYPE_CHECKING:
    from my_gpaw25.response.kpoints import KPointDomainGenerator
...
class Chi0DrudeCalculator(Chi0ComponentCalculator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # task: IntegralTask from my_gpaw25.response.integrators
    ...
    def _calculate(self, chi0_drude: Chi0DrudeData):
        ...
        # integrator: Integrator from my_gpaw25.response.integrators (or child)
        ...
        # zd: ComplexFrequencyDescriptor from my_gpaw25.response.frequencies
    ...
    def print_info(self, wd, rate):
        ...
        # context: ResponseContext from my_gpaw25.response.context
        self.context.print('\n'.join(isl))
...
class PlasmaFrequencyIntegrand(Integrand):
    ...
    def _band_summation(self):
        ...
        # gs: ResponseGroundStateAdapter from my_gpaw25.response.groundstate
    ...
    def matrix_element(self, point):
        ...
        # kptpair_factory: KPointPairFactory from my_gpaw25.response.pair
    ...
    def eigenvalues(self, point):
        ...
        # gs: ResponseGroundStateAdapter from my_gpaw25.response.groundstate
        gs = self._drude.gs
        # kd: KPointDescriptor object from my_gpaw25.kpt_descriptor
        kd = gs.kd
        k_v = point.kpt_c  # XXX v/c discrepancy
        # gd: GridDescriptor from my_gpaw25.grid_descriptor
        k_c = np.dot(self.cell_cv, k_v) / (2 * np.pi)
