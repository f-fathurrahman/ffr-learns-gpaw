...
from my_gpaw25.ffbt import rescaled_fourier_bessel_transform
from my_gpaw25.gaunt import gaunt, super_gaunt
from my_gpaw25.spherical_harmonics import Y
from my_gpaw25.atom.radialgd import RadialGridDescriptor
from my_gpaw25.sphere.rshe import RealSphericalHarmonicsExpansion
...
class LeanPAWDataset:
    ...
    def rescaled_fourier_bessel_transform(self, f_g, l):
        ...
        # Once rescaled by r^-l, we can use the my_gpaw25.ffbt module to Fast
    ...
    for j1, l1 in enumerate(l_j):
        ...
        for j2, l2 in enumerate(l_j):
            ...
            for l in range(abs(l1 - l2), l1 + l2 + 1, 2):
                ...
                # Fast Fourier Bessel Transform (FFBT) algorithm, see my_gpaw25.ffbt
...
def parallel_fourier_bessel_transform(k_G, *args, comm=None):
    ...
    if comm is None:
        from my_gpaw25.mpi import world as comm
