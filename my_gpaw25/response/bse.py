...
from my_gpaw25.blacs import BlacsGrid, Redistributor, BlacsDescriptor
from my_gpaw25.kpt_descriptor import KPointDescriptor
from my_gpaw25.mpi import world, serial_comm
from my_gpaw25.response import ResponseContext
from my_gpaw25.response.groundstate import CellDescriptor
from my_gpaw25.response.chi0 import Chi0Calculator
from my_gpaw25.response.context import timer
from my_gpaw25.response.coulomb_kernels import CoulombKernel
from my_gpaw25.response.df import write_response_function
from my_gpaw25.response.frequencies import FrequencyDescriptor
from my_gpaw25.response.pair import KPointPairFactory, get_gs_and_context
...
def parallel_delete(A_nn: np.ndarray,
    ...
    by the my_gpaw25.matrix.suggest_blocking function.
    -------------------
    Returns:
    A_rs: np.ndarray
...
class BSEBackend:
    ...
    def get_density_matrix(self, pair_calc, screened_potential, kpt1, kpt2):
        ...
        from my_gpaw25.response.g0w0 import QSymmetryOp, get_nmG
