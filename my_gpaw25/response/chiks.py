...
from my_gpaw25.utilities.blas import mmmx

from my_gpaw25.response import ResponseGroundStateAdapter, ResponseContext, timer
from my_gpaw25.response.symmetry import QSymmetryAnalyzer, QSymmetryInput
...
from my_gpaw25.response.matrix_elements import (PlaneWaveMatrixElementCalculator,
                                           NewPairDensityCalculator,
                                           TransversePairPotentialCalculator)
from my_gpaw25.response.pair_integrator import PairFunctionIntegrator
from my_gpaw25.response.pair_transitions import PairTransitions
from my_gpaw25.response.pair_functions import SingleQPWDescriptor, Chi
...
class GeneralizedSuscetibilityCalculator(PairFunctionIntegrator):
    ...
    def __init__(self, gs: ResponseGroundStateAdapter, context=None,
        ...
        kwargs : see my_gpaw25.response.pair_integrator.PairFunctionIntegrator
        """
        if context is None:
            context = ResponseContext()
