...
import my_gpaw25.fftw as fftw
from my_gpaw25 import debug
from my_gpaw25.core.arrays import DistributedArrays
from my_gpaw25.core.domain import Domain
from my_gpaw25.core.matrix import Matrix
from my_gpaw25.core.pwacf import PWAtomCenteredFunctions
from my_gpaw25.gpu import cupy as cp
from my_gpaw25.mpi import MPIComm, serial_comm
from my_gpaw25.new import prod, zips
from my_gpaw25.new.c import (add_to_density, add_to_density_gpu, pw_insert,
                        pw_insert_gpu)
from my_gpaw25.pw.descriptor import pad
from my_gpaw25.typing import (Array1D, Array2D, Array3D, ArrayLike1D, ArrayLike2D,
                         Vector)
from my_gpaw25.fftw import get_efficient_fft_size
...
class PWDesc(Domain):
    ...
    def atom_centered_functions(self,
        ...
        from my_gpaw25.new.spinspiral import SpiralPWACF
