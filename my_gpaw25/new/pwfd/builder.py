...
class PWFDDFTComponentsBuilder(DFTComponentsBuilder):
    ...
    def create_ibz_wave_functions(self, basis, potential, *, log):
        from my_gpaw25.new.lcao.builder import create_lcao_ibzwfs
