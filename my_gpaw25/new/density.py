...
from my_gpaw25.typing import Array3D, Vector
from my_gpaw25.utilities import unpack_hermitian, unpack_density
from my_gpaw25.new.symmetry import SymmetrizationPlan, GPUSymmetrizationPlan
...
class Density:
    ...
    def write(self, writer, precision='double'):
        from my_gpaw25.new.gpw import as_single_precision
