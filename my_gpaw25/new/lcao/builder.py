...
from my_gpaw25.new.fd.builder import FDDFTComponentsBuilder
from my_gpaw25.new.lcao.ibzwfs import LCAOIBZWaveFunctions
from my_gpaw25.new.lcao.eigensolver import LCAOEigensolver
from my_gpaw25.new.lcao.forces import TCIDerivatives
from my_gpaw25.new.lcao.hamiltonian import LCAOHamiltonian
from my_gpaw25.new.lcao.hybrids import HybridLCAOEigensolver, HybridXCFunctional
...
class LCAODFTComponentsBuilder(FDDFTComponentsBuilder):
    ...
    def create_eigensolver(self, hamiltonian):
        ...
        if self.params.eigensolver.get('name') == 'scissors':
            from my_gpaw25.lcao.scissors import ScissorsLCAOEigensolver
