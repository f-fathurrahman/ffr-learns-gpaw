...
from my_gpaw25.core.atom_arrays import (AtomArrays, AtomArraysLayout,
                                   AtomDistribution)
from my_gpaw25.core.domain import Domain
from my_gpaw25.gpu.mpi import CuPyMPI
from my_gpaw25.lfc import BasisFunctions
from my_gpaw25.mixer import MixerWrapper, get_mixer_from_keywords
from my_gpaw25.mpi import (broadcast, MPIComm, Parallelization, serial_comm,
                      synchronize_atoms, world)
from my_gpaw25.new import prod
from my_gpaw25.new.basis import create_basis
from my_gpaw25.new.brillouin import BZPoints, MonkhorstPackKPoints
...
from my_gpaw25.new.smearing import OccupationNumberCalculator
...
from my_gpaw25.typing import Array2D, ArrayLike1D, ArrayLike2D, DTypeLike
...
def builder(atoms: Atoms,
    ...
    * atom
    ...
    mod = importlib.import_module(f'my_gpaw25.new.{name}.builder')
...
class DFTComponentsBuilder:
    ...
    def xp(self) -> ModuleType:
        ...
        if self.gpu:
            from my_gpaw25.gpu import cupy
            return cupy
        return np
