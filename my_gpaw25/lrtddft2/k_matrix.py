...
from my_gpaw25.lrtddft2.eta import QuadraticETA
...
class Kmatrix:
    ...
    def read_indices(self):
        ...
        data = my_gpaw25.mpi.broadcast_string(data,
                                         root=0,
    ...
    def read_values(self):
        ...
        for (k,
            ...
            # read every "parent comm size"th file, starting from
            # parent comm rank
            if (k % self.lr_comms.parent_comm.size !=
                self.lr_comms.parent_comm.rank):
                continue
        ...
        alltoall_dict = my_gpaw25.mpi.alltoallv_string(elem_lists,
        ...
        #            my_gpaw25.mpi.send_string( elem_lists[receiving_proc],
        #                                  receiving_proc,
        #                                  comm=self.parent_comm)
        #        elif receiving_proc == self.parent_comm.rank:
        #            elist = my_gpaw25.mpi.receive_string( sending_proc,
        #                                             comm=self.parent_comm )
