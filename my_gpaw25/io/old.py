...
from my_gpaw25.io.tar import Reader
...
def wrap_old_gpw_reader(filename):
    ...
    if mixer == 'Mixer':
        ...
        from my_gpaw25.mixer import MixerSum as Mixer
    elif mixer == 'MixerSum2':
        from my_gpaw25.mixer import MixerSum2 as Mixer
    elif mixer == 'MixerDif':
        from my_gpaw25.mixer import MixerDif as Mixer
    elif mixer == 'DummyMixer':
        from my_gpaw25.mixer import DummyMixer as Mixer
    else:
        Mixer = None
