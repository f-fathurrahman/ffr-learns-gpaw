...
from my_gpaw25 import PoissonConvergenceError
from my_gpaw25.dipole_correction import DipoleCorrection, dipole_correction
from my_gpaw25.domain import decompose_domain
from my_gpaw25.fd_operators import Laplace, LaplaceA, LaplaceB
from my_gpaw25.transformers import Transformer
from my_gpaw25.utilities.gauss import Gaussian
from my_gpaw25.utilities.grid import grid2grid
from my_gpaw25.utilities.ewald import madelung
from my_gpaw25.utilities.tools import construct_reciprocal
...
def create_poisson_solver(name='fast', **kwargs):
    if isinstance(name, _PoissonSolver):
        ...
        from my_gpaw25.fdtd.poisson_fdtd import FDTDPoissonSolver
        ...
        from my_gpaw25.poisson_extravacuum import ExtraVacuumPoissonSolver
        return ExtraVacuumPoissonSolver(**kwargs)
    elif name == 'MomentCorrectionPoissonSolver':
        from my_gpaw25.poisson_moment import MomentCorrectionPoissonSolver
