...
from my_gpaw25.mpi import broadcast_array, serial_comm
from my_gpaw25.occupations import OccupationNumberCalculator, ParallelLayout
from my_gpaw25.projections import Projections
from my_gpaw25.setup import Setup
from my_gpaw25.typing import Array1D, Array2D, Array3D, Array4D, ArrayND
from my_gpaw25.utilities.partition import AtomPartition

if TYPE_CHECKING:
    from my_gpaw25.calculator import GPAW  # noqa
...
class BZWaveFunctions:
    ...
    def get_atomic_density_matrices(self):
        ...
        from my_gpaw25.new.wave_functions import add_to_4component_density_matrix
    ...
    def get_orbital_magnetic_moments(self):
        ...
        from my_gpaw25.new.orbmag import calculate_orbmag_from_density
...
def get_magnetic_moments(calc, theta=0.0, phi=0.0, nbands=None, width=None):
    ...
    from my_gpaw25.occupations import occupation_numbers
    if width is None:
