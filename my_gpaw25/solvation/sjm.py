...
import my_gpaw25.mpi
from my_gpaw25 import ConvergenceError
from my_gpaw25.jellium import Jellium, JelliumSlab
from my_gpaw25.hamiltonian import RealSpaceHamiltonian
from my_gpaw25.fd_operators import Gradient
from my_gpaw25.dipole_correction import DipoleCorrection
from my_gpaw25.solvation.cavity import Power12Potential, get_pbc_positions
from my_gpaw25.solvation.calculator import SolvationGPAW
...
class SJM(SolvationGPAW):
    ...
    def write_sjm_traces(self, path='sjm_traces', style='z',
        ...
        if not os.path.exists(path) and my_gpaw25.mpi.world.rank == 0:
            os.makedirs(path)
        for prop in props:
            if style == 'z':
    ...
    def summary(self):
        ...
        This varies from the implementation in my_gpaw25.calculator.GPAW by the
...
class SJMPower12Potential(Power12Potential):
    ...
    Power12Potential of my_gpaw25.solvation. This is a 1/r^{12} repulsive
