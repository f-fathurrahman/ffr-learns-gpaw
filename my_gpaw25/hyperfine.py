...
from my_gpaw25 import get_scipy_version
from my_gpaw25.atom.aeatom import Channel
...
from my_gpaw25.utilities import unpack_density
...
def main(argv: List[str] = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog='python3 -m my_gpaw25.hyperfine',
