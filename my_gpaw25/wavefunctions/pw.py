...
from my_gpaw25.blacs import BlacsDescriptor, BlacsGrid, Redistributor
from my_gpaw25.lfc import BasisFunctions
from my_gpaw25.matrix_descriptor import MatrixDescriptor
from my_gpaw25.pw.descriptor import PWDescriptor
from my_gpaw25.pw.lfc import PWLFC
from my_gpaw25.typing import Array2D
    ...
    def __init__(self,
        ...
        fftwflags: int
            ...
            (default is MEASURE)::
                ...
                from my_gpaw25.fftw import ESTIMATE, MEASURE, PATIENT, EXHAUSTIVE
        ...
        self.fftwflags = fftwflags if not my_gpaw25.dry_run else fftw.MEASURE
