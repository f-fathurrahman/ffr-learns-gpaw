...
from my_gpaw25.directmin.tools import loewdin_lcao, gramschmidt_lcao
from my_gpaw25.lcao.atomic_correction import (DenseAtomicCorrection,
                                         SparseAtomicCorrection)
# from my_gpaw25.lcao.overlap import NewTwoCenterIntegrals as NewTCI
...
from my_gpaw25.utilities.blas import mmm, gemmdot
...
class LCAOWaveFunctions(WaveFunctions):
    ...
    def calculate_density_matrix(self, f_n, C_nM, rho_MM=None):
        ...
        if 1:
            ...
            from my_gpaw25.utilities.blas import r2k
            C_Mn = C_nM.T.copy()
...
class LCAOforces:
    ...
    def __init__(self, ksl, dtype, gd, bd, kd, kpt_u, nspins, bfs, newtci,
        ...
        from my_gpaw25.kohnsham_layouts import BlacsOrbitalLayouts
    ...
    def get_kin_and_den_term_blacs(self):
        ...
        # from my_gpaw25.lcao.overlap import TwoCenterIntegralCalculator
