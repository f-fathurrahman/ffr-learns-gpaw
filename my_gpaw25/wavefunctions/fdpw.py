...
from my_gpaw25.matrix import Matrix, matrix_matrix_multiply as mmm
...
from my_gpaw25.wavefunctions.lcao import LCAOWaveFunctions, update_phases
...
class FDPWWaveFunctions(WaveFunctions):
    ...
    def initialize_wave_functions_from_basis_functions(self,
        ...
        if self.collinear:
            ...
            from my_gpaw25.xc.noncollinear import NonCollinearLCAOEigensolver
