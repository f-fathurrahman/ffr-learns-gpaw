...
from my_gpaw25.utilities import pack_density, unpack_density
from my_gpaw25.utilities.tools import pick
from my_gpaw25.lfc import LocalizedFunctionsCollection as LFC, BasisFunctions
    ...
    def __init__(self, density, spos_ac, finegrid):
        ...
        if not finegrid:
            density.Ghat = LFC(density.gd,
                               ...
                               integral=sqrt(4 * pi))
            density.Ghat.set_positions(spos_ac)
...
class PairDensity:
    ...
    def set_paw(self, paw):
        ...
        self.wfs = paw.wfs
        self.lcao = paw.wfs.mode == 'lcao'
        self.density = paw.density
        self.setups = paw.wfs.setups
        self.spos_ac = paw.spos_ac
