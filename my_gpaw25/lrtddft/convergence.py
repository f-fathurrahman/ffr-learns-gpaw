...
from my_gpaw25.lrtddft.spectrum import spectrum, rotatory_spectrum
...
def check_convergence(lr,             # LrTDDFT object
    ...
    with open(fname('conv.gpl'), 'w') as fgpl:
        ...
        if dE is None:
            ...
            for kss in lr.Om.kss:
                max_kss_energy = max(max_kss_energy,
                                     kss.get_energy() * Hartree)
