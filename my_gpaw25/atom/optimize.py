...
from my_gpaw25 import GPAW, PW, setup_paths, Mixer, ConvergenceError
from my_gpaw25.atom.generator2 import generate  # , DatasetGenerationError
from my_gpaw25.atom.aeatom import AllElectronAtom
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(usage='python -m my_gpaw25.atom.optimize '
