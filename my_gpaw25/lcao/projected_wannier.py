...
from my_gpaw25.lcao.overlap import NewTwoCenterIntegrals as TwoCenterIntegrals
from my_gpaw25.lfc import BasisFunctions
from my_gpaw25.utilities import unpack_hermitian
from my_gpaw25.utilities.tools import dagger, lowdin, tri2full
from my_gpaw25.lcao.tools import basis_subset2
...
class ProjectedWannierFunctions:
    ...
    def calculate_functions(self, calc, basis, k=0):
        from my_gpaw25.io import FileReference
