...
from my_gpaw25.mpi import serial_comm, rank
from my_gpaw25.kpt_descriptor import KPointDescriptor
from my_gpaw25.poisson import PoissonSolver, FFTPoissonSolver
from my_gpaw25.dfpt.responsecalculator import ResponseCalculator
from my_gpaw25.dfpt.phononperturbation import PhononPerturbation
from my_gpaw25.dfpt.wavefunctions import WaveFunctions
from my_gpaw25.dfpt.dynamicalmatrix import DynamicalMatrix
from my_gpaw25.dfpt.electronphononcoupling import ElectronPhononCoupling
    ...
    def band_structure(self, path_kc, modes=False, acoustic=True):
        ...
        for q_c in path_kc:
            ...
            if not np.all(omega2_n >= 0.):
                ...
                print(f'WARNING, {len(indices):d} imaginary frequencies at '
                      f'q = ({q_c[0]:5.2f}, {q_c[1]:5.2f}, {q_c[2]:5.2f}) ; '
                      f'(omega_q ={omega_n[indices][0].imag:5.3e}*i)')
