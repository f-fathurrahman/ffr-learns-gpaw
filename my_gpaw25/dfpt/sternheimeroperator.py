r"""This module implements the linear operator in the Sternheimer equation.
...
from my_gpaw25.fd_operators import Laplace
...
class SternheimerOperator:
    ...
    def apply(self, x_nG, y_nG):
        ...
        phase of the first-order of the state. Only for q=0 do the two
        coincide.
