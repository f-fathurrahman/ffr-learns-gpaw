...
from my_gpaw25.fd_operators import FDOperator
    ...
    def mix(self, nt_G, D_ap, phase_cd=None):
        ...
        if iold > 0:
            ...
            for R_1G in self.R_iG:
                ...
                a = self.gd.comm.sum_scalar(np.vdot(R_1G.real, mR_G.real))
                if self.dtype == complex:
                    a += self.gd.comm.sum_scalar(np.vdot(R_1G.imag, mR_G.imag))
