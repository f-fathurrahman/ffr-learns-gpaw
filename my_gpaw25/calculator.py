...
from my_gpaw25.band_descriptor import BandDescriptor
from my_gpaw25.convergence_criteria import dict2criterion
from my_gpaw25.density import RealSpaceDensity
from my_gpaw25.dos import DOSCalculator
from my_gpaw25.eigensolvers import get_eigensolver
...
from my_gpaw25.io import Reader, Writer
from my_gpaw25.io.logger import GPAWLogger
from my_gpaw25.jellium import create_background_charge
from my_gpaw25.kohnsham_layouts import get_KohnSham_layouts
from my_gpaw25.kpt_descriptor import KPointDescriptor
from my_gpaw25.kpt_refine import create_kpoint_descriptor_with_refinement
from my_gpaw25.matrix import suggest_blocking
from my_gpaw25.occupations import ParallelLayout, create_occ_calc
from my_gpaw25.output import (print_cell, print_parallelization_details,
                         print_positions)
from my_gpaw25.pw.density import ReciprocalSpaceDensity
from my_gpaw25.pw.hamiltonian import ReciprocalSpaceHamiltonian
from my_gpaw25.scf import SCFLoop, SCFEvent
from my_gpaw25.setup import Setups
from my_gpaw25.stress import calculate_stress
from my_gpaw25.symmetry import Symmetry
from my_gpaw25.typing import Array1D
from my_gpaw25.utilities import check_atoms_too_close, compiled_with_sl
from my_gpaw25.utilities.gpts import get_number_of_grid_points
from my_gpaw25.utilities.grid import GridRedistributor
from my_gpaw25.utilities.memory import MemNode, maxrss
from my_gpaw25.utilities.partition import AtomPartition
from my_gpaw25.wavefunctions.mode import create_wave_function_mode
...
class GPAW(Calculator):
    ...
    def _write(self, writer, mode):
        ...
        writer.write(version=3, gpaw_version=my_gpaw25.__version__,
                     ha=Ha, bohr=Bohr)
    ...
    def create_occupations(self, cell_cv, magmom, orbital_free, nvalence):
        ...
        if name == 'mom':
            from my_gpaw25.mom import OccupationsMOM
    ...
    def create_hamiltonian(self, realspace, mode, xc):
        ...
        if realspace:
            ...
            if self.parallel['augment_grids']:
                from my_gpaw25.grid_descriptor import BadGridError
                try:
    ...
    def dry_run(self):
        # Can be overridden like in my_gpaw25.atom.atompaw
        print_cell(self.wfs.gd, self.atoms.pbc, self.log)
        print_positions(self.atoms, self.log, self.density.magmom_av)
        self.log.fd.flush()
    ...
    def get_dos(self, spin=0, npts=201, width=None):
        ...
        from my_gpaw25.utilities.dos import fold
    ...
    def get_wigner_seitz_ldos(self, a, spin=0, npts=201, width=None):
        ...
        from my_gpaw25.utilities.dos import fold, raw_wignerseitz_LDOS
    ...
    def get_orbital_ldos(self, a,
        ...
        """
        from my_gpaw25.utilities.dos import fold, raw_orbital_LDOS
        if width is None:
            width = 0.1
    ...
    def get_lcao_dos(self, atom_indices=None, basis_indices=None,
        ...
        if self.wfs.S_qMM is None:
            from my_gpaw25.utilities.dos import RestartLCAODOS
            lcaodos = RestartLCAODOS(self)
        else:
            from my_gpaw25.utilities.dos import LCAODOS
    ...
    def get_all_electron_ldos(self, mol, spin=0, npts=201, width=None,
        ...
        """
        from my_gpaw25.utilities.dos import all_electron_LDOS, fold
