...
from my_gpaw25.new.brillouin import BZPoints
from my_gpaw25.new.builder import builder
...
def code():
    ...
    def include(obj):
        ...
        return mod.startswith('my_gpaw25.new')
    ...
    nodes = create_nodes(
        ...
        include=lambda obj:
            getattr(obj, '__module__', '').startswith('my_gpaw25.core') and
