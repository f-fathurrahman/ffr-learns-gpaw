...
from my_gpaw25 import GPAW_NEW
from my_gpaw25.calculator import GPAW
from my_gpaw25.external import ConstantElectricField, ExternalPotential
from my_gpaw25.lcaotddft.hamiltonian import TimeDependentHamiltonian
from my_gpaw25.lcaotddft.logger import TDDFTLogger
from my_gpaw25.lcaotddft.propagators import create_propagator
from my_gpaw25.tddft.units import attosec_to_autime
from my_gpaw25.typing import Any, Vector


def LCAOTDDFT(filename: str, **kwargs) -> Any:
    if GPAW_NEW:
        from my_gpaw25.new.rttddft import RTTDDFT
