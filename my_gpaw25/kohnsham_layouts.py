...
from my_gpaw25.utilities import uncamelcase
from my_gpaw25.utilities.blas import mmm, r2k
from my_gpaw25.utilities.scalapack import (pblas_simple_gemm, pblas_tran,
                                      scalapack_tri2full)
...
class BlacsOrbitalLayouts(BlacsLayouts):
    ...
    def calculate_blocked_density_matrix(self, f_n, C_nM):
        ...
        if 1:  # if self.libelpa is None:
            ...
            from my_gpaw25.utilities.scalapack import pblas_tran
