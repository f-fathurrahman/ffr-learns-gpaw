...
from my_gpaw25.gaunt import gaunt, nabla
from my_gpaw25.overlap import OverlapCorrections
from my_gpaw25.setup_data import SetupData, search_for_file
from my_gpaw25.spline import Spline
from my_gpaw25.utilities import pack_density, unpack_hermitian
from my_gpaw25.xc import XC
from my_gpaw25.new import zips
from my_gpaw25.xc.ri.spherical_hse_kernel import RadialHSE
...
def create_setup(symbol, xc='LDA', lmax=0,
    ...
    if isinstance(type, str) and ':' in type:
        from my_gpaw25.hubbard import parse_hubbard_string
    ...
    if setupdata is None:
        if type == 'hgh' or type == 'hgh.sc':
            lmax = 0
            from my_gpaw25.hgh import HGHSetupData, sc_setups, setups
            if type == 'hgh.sc':
                table = sc_setups
            else:
                table = setups
            ...
            from my_gpaw25.ah import AppelbaumHamann
            ah = AppelbaumHamann()
            ah.build(basis)
            return ah
        elif type == 'ae':
            from my_gpaw25.ae import HydrogenAllElectronSetup
            assert symbol == 'H'
            ae = HydrogenAllElectronSetup()
            ae.build(basis)
            return ae
        elif type == 'ghost':
            from my_gpaw25.lcao.bsse import GhostSetupData
...
class BaseSetup:
    ...
    def four_phi_integrals(self):
        ...
        # https://my_gpaw25.readthedocs.io/devel/overview.html
...
class Setups(list):
    ...
    def set_symmetry(self, symmetry):
        ...
        from my_gpaw25.atomrotations import AtomRotations
    ...
    def estimate_dedecut(self, ecut):
        from my_gpaw25.utilities.ekin import dekindecut, ekin
        dedecut = 0.0
        e = {}
        for id in self.id_a:
            if id not in e:
