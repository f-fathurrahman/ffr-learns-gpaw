...
from my_gpaw25.utilities.blas import axpy, gemmdot
from my_gpaw25.xc.rpa import RPACorrelation
from my_gpaw25.heg import HEG
from my_gpaw25.xc.fxc_kernels import (
...
class KernelDens(KernelIntegrator):
    ...
    def get_pbe_g(self, n_g, index=None):
        ...
        from my_gpaw25.xc.fxc_kernels import get_pbe_fxc
