...
from my_gpaw25.mpi import have_mpi
from my_gpaw25.utilities import compiled_with_libvdwxc
from my_gpaw25.utilities.grid_redistribute import Domains, general_redistribute
from my_gpaw25.utilities.timing import nulltimer
from my_gpaw25.xc.functional import XCFunctional
from my_gpaw25.xc.gga import GGA, gga_vars, add_gradient_correction
...
def vdw_beef(**kwargs):
    ...
    from my_gpaw25.xc.bee import BEEVDWKernel
...
def test_selfconsistent():
    ...
    def test(xc):
        calc = GPAW(mode='lcao',
                    xc=xc,
                    setups='sg15',
                    txt='my_gpaw25.%s.txt' % str(xc)  # .kernel.name
                    )
        system.calc = calc
