from my_gpaw25.xc.gllb.nonlocalfunctional import NonLocalFunctional
...
def get_nonlocal_functional(name: str,
    ...
    stencil:
        parameter passed to :class:`~my_gpaw25.xc.gga.GGA`
    metallic:
        parameter passed to :class:`~my_gpaw25.xc.gllb.coefficients.Coefficients`
    width:
        parameter passed to :class:`~my_gpaw25.xc.gllb.coefficients.Coefficients`
    eps:
        parameter passed to :class:`~my_gpaw25.xc.gllb.coefficients.Coefficients`
    ...
    * GLLBPBE (A test functional, which is just PBE but via
               NonLocalFunctional framework)
    """
    from my_gpaw25.xc.gllb.c_gllbscr import C_GLLBScr
    from my_gpaw25.xc.gllb.c_response import C_Response
    from my_gpaw25.xc.gllb.c_xc import C_XC
    from my_gpaw25.xc.gllb.coefficients import Coefficients
