...
from my_gpaw.density import RealSpaceDensity
from my_gpaw.dos import DOSCalculator
from my_gpaw.eigensolvers import get_eigensolver
...
from my_gpaw.hamiltonian import RealSpaceHamiltonian
from my_gpaw.hybrids import HybridXC
from my_gpaw.io import Reader, Writer
from my_gpaw.io.logger import GPAWLogger
from my_gpaw.jellium import create_background_charge
from my_gpaw.kohnsham_layouts import get_KohnSham_layouts
from my_gpaw.kpt_descriptor import KPointDescriptor
from my_gpaw.kpt_refine import create_kpoint_descriptor_with_refinement
from my_gpaw.matrix import suggest_blocking
from my_gpaw.occupations import ParallelLayout, create_occ_calc
from my_gpaw.output import (print_cell, print_parallelization_details,
                         print_positions)
from my_gpaw.pw.density import ReciprocalSpaceDensity
from my_gpaw.pw.hamiltonian import ReciprocalSpaceHamiltonian
from my_gpaw.scf import SCFLoop
from my_gpaw.setup import Setups
from my_gpaw.stress import calculate_stress
from my_gpaw.symmetry import Symmetry
from my_gpaw.typing import Array1D
from my_gpaw.utilities import check_atoms_too_close, compiled_with_sl
from my_gpaw.utilities.gpts import get_number_of_grid_points
from my_gpaw.utilities.grid import GridRedistributor
from my_gpaw.utilities.memory import MemNode, maxrss
from my_gpaw.utilities.partition import AtomPartition
from my_gpaw.wavefunctions.mode import create_wave_function_mode
from my_gpaw.xc import XC
from my_gpaw.xc.kernel import XCKernel
from my_gpaw.xc.sic import SIC
...
class GPAW(Calculator):
    ...
    def create_occupations(self, cell_cv, magmom, orbital_free, nvalence):
        ...
        if name == 'mom':
            from my_gpaw.mom import OccupationsMOM
    ...
    def create_hamiltonian(self, realspace, mode, xc):
        ...
        if realspace:
            ...
            if self.parallel['augment_grids']:
                from my_gpaw.grid_descriptor import BadGridError
                try:
    ...
    def get_dos(self, spin=0, npts=201, width=None):
        ...
        from my_gpaw.utilities.dos import fold
    ...
    def get_wigner_seitz_ldos(self, a, spin=0, npts=201, width=None):
        ...
        from my_gpaw.utilities.dos import fold, raw_wignerseitz_LDOS
    ...
    def get_orbital_ldos(self, a,
        ...
        """
        from my_gpaw.utilities.dos import fold, raw_orbital_LDOS
        if width is None:
            width = 0.1
    ...
    def get_lcao_dos(self, atom_indices=None, basis_indices=None,
        ...
        if self.wfs.S_qMM is None:
            from my_gpaw.utilities.dos import RestartLCAODOS
    ...
    def get_all_electron_ldos(self, mol, spin=0, npts=201, width=None,
        ...
        """
        from my_gpaw.utilities.dos import all_electron_LDOS, fold
    ...
    def get_nonselfconsistent_energies(self, type='beefvdw'):
        from my_gpaw.xc.bee import BEEFEnsemble
