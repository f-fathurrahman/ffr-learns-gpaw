...
from my_gpaw.mpi import have_mpi
from my_gpaw.utilities import compiled_with_libvdwxc
from my_gpaw.utilities.grid_redistribute import Domains, general_redistribute
from my_gpaw.utilities.timing import nulltimer
from my_gpaw.xc.functional import XCFunctional
from my_gpaw.xc.gga import GGA, gga_vars, add_gradient_correction
...
def vdw_beef(**kwargs):
    ...
    from my_gpaw.xc.bee import BEEVDWKernel
