...
from my_gpaw.utilities.blas import axpy, gemmdot
from my_gpaw.xc.rpa import RPACorrelation
from my_gpaw.heg import HEG
from my_gpaw.xc.fxc_kernels import (
...
class KernelDens(KernelIntegrator):
    ...
    def get_pbe_g(self, n_g, index=None):
        ...
        from my_gpaw.xc.fxc_kernels import get_pbe_fxc
