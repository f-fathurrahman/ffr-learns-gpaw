...
from my_gpaw.blacs import BlacsDescriptor, BlacsGrid, Redistributor
from my_gpaw.lfc import BasisFunctions
from my_gpaw.matrix_descriptor import MatrixDescriptor
...
from my_gpaw.wavefunctions.fdpw import FDPWWaveFunctions
    ...
    def __init__(self,
        ...
        fftwflags: int
            ...
            (default is MEASURE)::
                ...
                from my_gpaw.fftw import ESTIMATE, MEASURE, PATIENT, EXHAUSTIVE
        ...
        self.fftwflags = fftwflags if not my_gpaw.dry_run else fftw.MEASURE
