...
from my_gpaw.pw.descriptor import pad
from my_gpaw.typing import (Array1D, Array2D, Array3D, ArrayLike1D, ArrayLike2D,
                         Vector)
...
class PlaneWaves(Domain):
    ...
    def atom_centered_functions(self,
        ...
        from my_gpaw.new.spinspiral import SpiralPWACF
