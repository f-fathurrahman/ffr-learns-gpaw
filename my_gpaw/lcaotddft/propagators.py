...
from my_gpaw.tddft.units import au_to_as
from my_gpaw.utilities.scalapack import (pblas_simple_hemm, pblas_simple_gemm,
...
class ECNPropagator(LCAOPropagator):
    ...
    def initialize(self, paw, hamiltonian=None):
        ...
        if using_blacs:
            from my_gpaw.blacs import Redistributor
