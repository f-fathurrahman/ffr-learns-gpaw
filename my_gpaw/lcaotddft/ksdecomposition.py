...
from my_gpaw.lcaotddft.hamiltonian import KickHamiltonian
from my_gpaw.lcaotddft.utilities import collect_MM
from my_gpaw.lcaotddft.utilities import distribute_nM
from my_gpaw.lcaotddft.utilities import read_uMM
from my_gpaw.lcaotddft.utilities import write_uMM
from my_gpaw.lcaotddft.utilities import read_uX, write_uX
...
class KohnShamDecomposition(object):
    ...
    def get_density(self, wfs, rho_up, density='comp'):
        from my_gpaw.lcaotddft.densitymatrix import get_density
    ...
    def plot_TCM(self, weight_p, energy_o, energy_u, sigma,
        ...
        from my_gpaw.lcaotddft.tcm import TCMPlotter
