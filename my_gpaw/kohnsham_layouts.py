...
from my_gpaw.mpi import broadcast_exception
from my_gpaw.blacs import BlacsGrid, Redistributor
from my_gpaw.utilities import uncamelcase
from my_gpaw.utilities.blas import mmm, r2k
from my_gpaw.utilities.scalapack import (pblas_simple_gemm, pblas_tran,
                                      scalapack_tri2full)
...
class BlacsOrbitalLayouts(BlacsLayouts):
    ...
    def calculate_blocked_density_matrix(self, f_n, C_nM):
        ...
        if 1:  # if self.libelpa is None:
            ...
            from my_gpaw.utilities.scalapack import pblas_tran
