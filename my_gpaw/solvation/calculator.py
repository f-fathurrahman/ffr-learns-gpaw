...
from my_gpaw.io import Reader
from my_gpaw.solvation.hamiltonian import SolvationRealSpaceHamiltonian
        ...
        if 'implicit_solvent' in reader:
            ...
            if 'name' in impl_in.cavity.effective_potential:
                ...
                if efpot.name == 'SJMPower12Potential':
                    from my_gpaw.solvation.sjm import SJMPower12Potential
                    ...
                    from my_gpaw.solvation.sjm import Power12Potential
            ...
            if 'name' in impl_in.cavity.surface_calculator:
                ...
                if suca.name == 'GradientSurface':
                    from my_gpaw.solvation.cavity import GradientSurface
            ...
            from my_gpaw.solvation.cavity import EffectivePotentialCavity
            ...
            if impl_in.dielectric.name == 'LinearDielectric':
                from my_gpaw.solvation.dielectric import LinearDielectric
            ...
            if impl_in.interactions.name == 'SurfaceInteraction':
                ...
                from my_gpaw.solvation.interactions import SurfaceInteraction
