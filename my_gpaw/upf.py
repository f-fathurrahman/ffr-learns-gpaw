...
from my_gpaw.setup_data import search_for_file
from my_gpaw.basis_data import Basis, BasisFunction
from my_gpaw.pseudopotential import (PseudoPotential, screen_potential,
                                  figure_out_valence_states,
                                  get_radial_hartree_energy)
from my_gpaw.spline import Spline
from my_gpaw.utilities import pack2, divrl
...
class UPFSetupData:
    ...
    def create_basis_functions(self):
        if len(self.data['states']) > 0:
            ...
            from my_gpaw.pseudopotential import generate_basis_functions
