...
from my_gpaw import GPAW, debug
import my_gpaw.mpi as mpi
from my_gpaw.hybrids.eigenvalues import non_self_consistent_eigenvalues
from my_gpaw.pw.descriptor import (count_reciprocal_vectors, PWMapping)
...
from my_gpaw.response.pair import PairDensityCalculator, phase_shifted_fft_indices
...
class G0W0(G0W0Calculator):
    def __init__(self, calc, filename='gw',
        ...
        from my_gpaw.response.chi0 import new_frequency_descriptor
