...
from my_gpaw.response.df import write_response_function
...
from my_gpaw.response.paw import PWPAWCorrectionData
from my_gpaw.response.frequencies import FrequencyDescriptor
from my_gpaw.response.pair import PairDensityCalculator, get_gs_and_context
from my_gpaw.response.pair_functions import SingleQPWDescriptor
from my_gpaw.response.chi0 import Chi0Calculator
...
class BSEBackend:
    ...
    def get_density_matrix(self, kpt1, kpt2):
        from my_gpaw.response.g0w0 import QSymmetryOp, get_nmG
