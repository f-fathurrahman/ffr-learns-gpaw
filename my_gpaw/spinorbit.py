...
from my_gpaw.mpi import broadcast_array, serial_comm
from my_gpaw.occupations import OccupationNumberCalculator, ParallelLayout
from my_gpaw.projections import Projections
from my_gpaw.setup import Setup
from my_gpaw.typing import Array1D, Array2D, Array3D, Array4D, ArrayND
from my_gpaw.utilities.ibz2bz import construct_symmetry_operators
from my_gpaw.utilities.partition import AtomPartition

if TYPE_CHECKING:
    from my_gpaw.calculator import GPAW  # noqa
    from my_gpaw.new.ase_interface import ASECalculator
...
def get_magnetic_moments(calc, theta=0.0, phi=0.0, nbands=None, width=None):
    ...
    from my_gpaw.occupations import occupation_numbers
    if width is None:
