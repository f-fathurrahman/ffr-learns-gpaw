...
from my_gpaw.lcao.overlap import NewTwoCenterIntegrals as TwoCenterIntegrals
from my_gpaw.lfc import BasisFunctions
from my_gpaw.utilities import unpack
from my_gpaw.utilities.tools import dagger, lowdin, tri2full
from my_gpaw.lcao.tools import basis_subset2
...
class ProjectedWannierFunctions:
    ...
    def calculate_functions(self, calc, basis, k=0):
        from my_gpaw.io import FileReference
