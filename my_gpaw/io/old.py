...
from my_gpaw.io.tar import Reader
...
def wrap_old_gpw_reader(filename):
    ...
    if mixer == 'Mixer':
        ...
        from my_gpaw.mixer import MixerSum as Mixer
    elif mixer == 'MixerSum2':
        from my_gpaw.mixer import MixerSum2 as Mixer
    elif mixer == 'MixerDif':
        from my_gpaw.mixer import MixerDif as Mixer
    elif mixer == 'DummyMixer':
        from my_gpaw.mixer import DummyMixer as Mixer
    else:
        Mixer = None
