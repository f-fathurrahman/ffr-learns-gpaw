...
from my_gpaw.directmin.sd_etdm import SteepestDescent, FRcg, QuickMin, LBFGS, \
    LBFGS_P, LSR1P, ModeFollowing
from my_gpaw.directmin.ls_etdm import MaxStep, StrongWolfeConditions, Parabola
...
def partial_diagonalizer(method, domom):
    from my_gpaw.directmin.derivatives import Davidson
    if isinstance(method, str):
        method = xc_string_to_dict(method)
