...
from my_chi0 import Chi0Calculator, get_frequency_descriptor
...
class G0W0(G0W0Calculator):
    def __init__(self, calc, filename='gw',
        ...
        print(f"ecut = {ecut} ecut_e={ecut_e}")
        # XXX the units? in Ha ? eV ?

        #XXX approximated needed number of bands?
        if nbands is None:
