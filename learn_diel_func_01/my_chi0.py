...
from my_chi0_data import (Chi0Data, Chi0BodyData,
...
from my_chi0_base import Chi0ComponentPWCalculator, Chi0Integrand
...
class Chi0Calculator:
    ...
    def calculate(self, q_c: list | np.ndarray) -> Chi0Data:
        ...
        print("--- ENTER Chi0Calculator.calculate")
        ...
        print("qpd.optical_limit = ", qpd.optical_limit)
        #
